...
var useReferenceManyFieldController = function (props) {
    var _a = props.debounce, debounce = _a === void 0 ? 500 : _a, reference = props.reference, record = props.record, target = props.target, _b = props.filter, filter = _b === void 0 ? defaultFilter : _b, _c = props.source, source = _c === void 0 ? 'id' : _c, initialPage = props.page, initialPerPage = props.perPage, _d = props.sort, initialSort = _d === void 0 ? { field: 'id', order: 'DESC' } : _d, _e = props.queryOptions, queryOptions = _e === void 0 ? {} : _e;
    ...
    // sort logic
    var _g = (0, useSortState_1.default)(initialSort), sort = _g.sort, setSortState = _g.setSort;
    var setSort = (0, react_1.useCallback)(function (sort) {
        setSortState(sort);
        setPage(1);
    }, [setPage, setSortState]);
    // selection logic
    var _h = (0, useRecordSelection_1.useRecordSelection)({
    ...
    var _l = (0, dataProvider_1.useGetManyReference)(reference, {
        target: target,
        ...
        } }, otherQueryOptions)), data = _l.data, total = _l.total, pageInfo = _l.pageInfo, error = _l.error, isFetching = _l.isFetching, isLoading = _l.isLoading, isPending = _l.isPending, refetch = _l.refetch;
    return {
        sort: sort,
        data: data,
