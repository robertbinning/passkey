 ...
 * };
 */
export declare const useGetMany: <RecordType extends RaRecord<import("../types").Identifier> = any>(resource: string, params?: Partial<GetManyParams>, options?: UseGetManyOptions<RecordType>) => UseGetManyHookValue<RecordType>;
export type UseGetManyOptions<RecordType extends RaRecord = any> = Omit<UseQueryOptions<RecordType[], Error>, 'queryKey' | 'queryFn'> & {
