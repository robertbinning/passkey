 ...
 * };
 */
export declare const useGetManyAggregate: <RecordType extends RaRecord<Identifier> = any>(resource: string, params: GetManyParams, options?: UseGetManyAggregateOptions<RecordType>) => UseGetManyHookValue<RecordType>;
