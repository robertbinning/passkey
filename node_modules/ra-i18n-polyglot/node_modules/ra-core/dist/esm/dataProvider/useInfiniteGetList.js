...
export var useInfiniteGetList = function (resource, params, options) {
    ...
    var _g = options.onSuccess, onSuccess = _g === void 0 ? noop : _g, _h = options.onError, onError = _h === void 0 ? noop : _h, _j = options.onSettled, onSettled = _j === void 0 ? noop : _j, queryOptions = __rest(options, ["onSuccess", "onError", "onSettled"]);
