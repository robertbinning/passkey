...
export var useGetOne = function (resource, _a, options) {
    ...
    var _b = options.onError, onError = _b === void 0 ? noop : _b, _c = options.onSuccess, onSuccess = _c === void 0 ? noop : _c, _d = options.onSettled, onSettled = _d === void 0 ? noop : _d, queryOptions = __rest(options, ["onError", "onSuccess", "onSettled"]);
