 ...
 * };
 */
export declare const useGetOne: <RecordType extends RaRecord<import("../types").Identifier> = any>(resource: string, { id, meta }: GetOneParams<RecordType>, options?: UseGetOneOptions<RecordType>) => UseGetOneHookValue<RecordType>;
