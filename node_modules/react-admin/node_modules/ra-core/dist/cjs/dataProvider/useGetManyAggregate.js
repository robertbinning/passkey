...
var useGetManyAggregate = function (resource, params, options) {
    ...
    var _a = options.onError, onError = _a === void 0 ? noop : _a, _b = options.onSuccess, onSuccess = _b === void 0 ? noop : _b, _c = options.onSettled, onSettled = _c === void 0 ? noop : _c, queryOptions = __rest(options, ["onError", "onSuccess", "onSettled"]);
    ...
    var result = (0, react_query_1.useQuery)(__assign({ queryKey: [
        ...
        }, placeholderData: placeholderData, retry: false }, queryOptions));
