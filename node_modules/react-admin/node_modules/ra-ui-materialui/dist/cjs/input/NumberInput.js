...
var NumberInput = function (_a) {
    ...
    var _e = (0, ra_core_1.useInput)(__assign({ defaultValue: defaultValue, onBlur: onBlur, resource: resource, source: source, validate: validate }, rest)), field = _e.field, _f = _e.fieldState, error = _f.error, invalid = _f.invalid, id = _e.id, isRequired = _e.isRequired;
