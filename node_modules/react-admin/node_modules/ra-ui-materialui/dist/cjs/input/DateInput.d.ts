 ...
 */
export declare const DateInput: ({ className, defaultValue, format, label, name, source, resource, helperText, margin, onBlur, onChange, parse, validate, variant, ...rest }: DateInputProps) => React.JSX.Element;
