...
var NullableBooleanInput = function (props) {
    ...
    var _f = (0, ra_core_1.useInput)(__assign({ format: format, parse: parse, onBlur: onBlur, onChange: onChange, resource: resource, source: source, validate: validate }, rest)), field = _f.field, _g = _f.fieldState, error = _g.error, invalid = _g.invalid, id = _f.id, isRequired = _f.isRequired;
