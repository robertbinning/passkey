...
import { FilterPayload, SortPayload, RaRecord } from 'ra-core';
...
export interface ReferenceManyFieldProps<RecordType extends Record<string, any> = Record<string, any>, ReferenceRecordType extends Record<string, any> = Record<string, any>> extends Omit<FieldProps<RecordType>, 'source'> {
    children: ReactNode;
    debounce?: number;
