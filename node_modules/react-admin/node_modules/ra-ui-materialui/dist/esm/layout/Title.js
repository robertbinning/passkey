...
export var Title = function (props) {
    ...
    return (React.createElement(React.Fragment, null, createPortal(React.createElement(PageTitleConfigurable, __assign({ title: title, defaultTitle: defaultTitle, preferenceKey: preferenceKey }, rest)), container)));
};
