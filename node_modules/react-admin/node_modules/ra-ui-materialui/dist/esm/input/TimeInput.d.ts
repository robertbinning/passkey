 ...
 * );
 */
export declare const TimeInput: ({ className, defaultValue, format, label, helperText, margin, onBlur, onChange, source, resource, parse, validate, variant, ...rest }: TimeInputProps) => React.JSX.Element;
