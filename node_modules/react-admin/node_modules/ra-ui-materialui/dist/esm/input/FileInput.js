...
export var FileInput = function (props) {
    ...
    var _e = useInput(__assign({ format: format || transformFiles, parse: parse || transformFiles, source: source, validate: validate }, rest)), id = _e.id, _f = _e.field, onChange = _f.onChange, onBlur = _f.onBlur, value = _f.value, fieldState = _e.fieldState, isRequired = _e.isRequired;
    ...
    return (React.createElement(StyledLabeled, __assign({ htmlFor: id, label: label, className: clsx('ra-input', "ra-input-".concat(source), className), source: source, resource: resource, isRequired: isRequired, color: invalid ? 'error' : undefined }, sanitizeInputRestProps(rest)),
