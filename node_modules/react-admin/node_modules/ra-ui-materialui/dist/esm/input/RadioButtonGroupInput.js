...
export var RadioButtonGroupInput = function (props) {
    ...
    var _f = useInput(__assign({ format: format, onBlur: onBlur, onChange: onChange, parse: parse, resource: resource, source: source, validate: validate }, rest)), id = _f.id, isRequired = _f.isRequired, fieldState = _f.fieldState, field = _f.field;
    ...
    return (React.createElement(StyledFormControl, __assign({ component: "fieldset", className: clsx('ra-input', "ra-input-".concat(source), className), margin: margin, error: fetchError || invalid }, sanitizeRestProps(rest)),
