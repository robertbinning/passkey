...
export var FilterButton = function (props) {
    ...
    var _a = useListContext(), _b = _a.displayedFilters, displayedFilters = _b === void 0 ? {} : _b, filterValues = _a.filterValues, perPage = _a.perPage, setFilters = _a.setFilters, showFilter = _a.showFilter, sort = _a.sort;
    ...
    return (React.createElement(Root, __assign({ className: className }, sanitizeRestProps(rest)),
        ...
        React.createElement(Menu, { open: open, anchorEl: anchorEl.current, onClose: handleRequestClose },
            ...
            hasFilterValues &&
                ...
                !disableSaveQuery && (React.createElement(MenuItem, { onClick: showAddSavedQueryDialog }, translate('ra.saved_queries.new_label', {
